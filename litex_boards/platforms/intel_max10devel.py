...
#
# Copyright (c) 2014-2019 Martijn Vervoort <martijnv@gmx.de>
...
_io = [
    # Clk / Rst.
#    ("clk_25_max10",    0, Pins("M8"),  IOStandard("2.5 V")),
#    ("clk_50_max10",    0, Pins("M9"),  IOStandard("2.5 V")),
#    ("rst_n",           0, Pins("D9"),  IOStandard("3.3-V LVTTL")),
    ...
    # Serial
    ("serial", 0,
     Subsignal("tx", Pins("W18"), IOStandard("3.3-V LVTTL")),
     Subsignal("rx", Pins("Y19"), IOStandard("3.3-V LVTTL"))
     ),
...
#        self.add_platform_command("set_global_assignment -name INTERNAL_FLASH_UPDATE_MODE \"SINGLE IMAGE WITH ERAM\"")
    ...
    def create_programmer(self) -> object:
